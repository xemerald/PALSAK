...
void InstallComInputData( int port,int (*)(unsigned char)); /* [2007/10/02] */
int IsComOutBufEmpty(int port); /* [2007/10/02] */
int SetComTimeout(int port,unsigned t); /* [2007/10/02] */
...
extern void (*InstallComInputData_[COM_PORT_NO+1])(int (*)(unsigned char)); /* [2007/10/02] */
extern int (*IsComOutBufEmpty_[COM_PORT_NO+1])(void); /* [2007/10/02] */
extern void (*SetComTimeout_[COM_PORT_NO+1])(unsigned t); /* [2007/10/02] */
...
/*
[2007/12/12] add function for system new timer ISR
*/
...
/*
[2010/03/18] Add functions for delay function to use Timer 0 or Timer 1.
*/
...
/* End of [2010/03/18] Add functions */

/* [2012/04/13] for TC,TC++,BC++ */

#define D_EQ_SwapShort_S(D,S) _AX=S; _asm xchg al,ah; D=_AX
/* End of [2012/04/13] */

/* [2012/04/26] */
int CsvStrToArg(char *cmd);
/*
...
FILE_DATA far *OS7_GetFirstFile(int disk,FILE_DATA far *fd);
FILE_DATA far *OS7_GetNextFile(FILE_DATA far *fd);
